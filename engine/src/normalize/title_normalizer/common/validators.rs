use crate::normalize::title_normalizer::common::{SEPS, SEPS_NO_FS, SEPS_NO_GROUPS};
use regex::Regex;
...
pub fn seps_surround_no_groups(string: &str, match_start: usize, match_end: usize) -> bool {
    seps_before_no_groups(string, match_start, match_end)
        && seps_after_no_groups(string, match_start, match_end)
}
...
pub fn seps_surround_no_fs(string: &str, match_start: usize, match_end: usize) -> bool {
    seps_before_no_fs(string, match_start, match_end)
        && seps_after_no_fs(string, match_start, match_end)
}
...
pub fn and(
    validators: &[fn(&str, usize, usize) -> bool],
) -> impl Fn(&str, usize, usize) -> bool + '_ {
    move |string: &str, start: usize, end: usize| {
        validators
            .iter()
            .all(|validator| validator(string, start, end))
    }
}
...
pub fn or(
    ...
    move |string: &str, start: usize, end: usize| {
        validators
            .iter()
            .any(|validator| validator(string, start, end))
    }
}
